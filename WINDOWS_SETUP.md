...
3. Navigate to the `DeepInsight` folder and click "Select Folder"
...
```bash
# If your project is at C:\Users\YourName\Downloads\DeepInsight
cd /mnt/c/Users/YourName/Downloads/DeepInsight
```
...
1. **File → Open Folder**
2. Select the `DeepInsight` folder
...
**Fix:**
Make sure you're in the `DeepInsight` folder:
```cmd
cd C:\full\path\to\DeepInsight
dir include
```
